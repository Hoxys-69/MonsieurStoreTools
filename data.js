  ...
  automates: [
    {
      category: "automates",
      marque: "Somfy",
      modele: "TaHoma Switch",
      guides: [
        { 
          titre: "Appairage moteur RTS", 
          etapes: [
            "Ouvrir l’application TaHoma.",
            "Aller dans 'Ajouter un équipement'.",
            "Choisir RTS puis suivre les étapes.",
            "Appuyer 3s sur PROG d’une télécommande RTS existante."
          ],
          expert: [
            "Portée radio RTS : environ 200m en champ libre, 20m en intérieur.",
            "Compatibilité : RTS, io-homecontrol, Zigbee (selon version)."
          ]
        },
        { 
          titre: "Création d’un scénario", 
          etapes: [
            "Depuis l’app, aller dans 'Scénarios'.",
            "Choisir un déclencheur (horaire, capteur soleil/vent...).",
            "Sélectionner les actions (fermer volets, allumer lumières).",
            "Sauvegarder et tester."
          ],
          expert: [
            "Les scénarios sont stockés dans le cloud Somfy.",
